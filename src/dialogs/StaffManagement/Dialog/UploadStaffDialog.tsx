...
import { uploadStaff } from "services/Staff/staff-api";

export interface UploadStaffDialogProps {
    open: boolean,
    onClose: () => void;
}

export default function UploadStaffDialog(props: UploadStaffDialogProps): JSX.Element {
    ...
    const handleConfirmUpload = async () => {
        ...
        toast.promise(uploadStaff(formData),
            {
        ...
        <Dialog open={open} maxWidth="xs" fullWidth aria-labelledby="form-dialog-title" >
            <DialogTitle id="form-dialog-title">
                <Box display="flex" justifyContent="space-between" alignItems="center">
                    <Typography variant="h6">
                        {t('staffManagement.importStaff')}
                    </Typography>
                    <Typography
                        variant="subtitle2"
                        onClick={() => {
                            handleDownloadTemplate('TEMPL-00006');
                        }}
            ...
            <DialogActions>
                ...
                <Button
                    ...
                    onClick={() => {
                        setTitle(t('staffManagement.confirmUploadTitle'));
                        setMsg(t('staffManagement.confirmUploadMsg'));
                        setAction('SUBMIT');

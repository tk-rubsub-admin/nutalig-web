...
import { Box, Button, Card, CardContent, Checkbox, Divider, FormControlLabel, Grid, IconButton, InputAdornment, MenuItem, Paper, Select, Stack, Switch, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Typography, useMediaQuery } from "@mui/material";
...
export default function NewBilling() {
    ...
    const formik = useFormik({
        initialValues: {
            billingDate: invoices.length > 0 ? today : null,
    ...
    return (
        <Page>
            <PageTitle title={t('billingManagement.new.title')} />
            <Wrapper>
                <Stack

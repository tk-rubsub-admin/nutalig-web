...
import { uploadFreight } from "services/Freight/freight-api";
import { downloadTemplate } from "services/Product/product-api";

export interface UploadFreightDialogProps {
    open: boolean,
    onClose: (jobId?: string) => void;
}

export default function UploadFreightDialog(props: UploadFreightDialogProps): JSX.Element {
    ...
    const handleConfirmUpload = async () => {
        ...
        toast.promise(uploadFreight(formData),
            {
        ...
        <Dialog open={open} maxWidth="xs" fullWidth aria-labelledby="form-dialog-title" >
            <DialogTitle id="form-dialog-title">
                <Box display="flex" justifyContent="space-between" alignItems="center">
                    <Typography variant="h6">
                        {t('freightManagement.importFrieght')}
                    </Typography>
                    <Typography
                        variant="subtitle2"
                        onClick={() => {
                            handleDownloadTemplate('TEMPL-00004');
                        }}
            ...
            <DialogActions>
                ...
                <Button
                    ...
                    onClick={() => {
                        setTitle(t('freightManagement.confirmUploadTitle'));
                        setMsg(t('freightManagement.confirmUploadMsg'));
                        setAction('SUBMIT');

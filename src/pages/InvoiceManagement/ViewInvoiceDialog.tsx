...
import { downloadInvoiceGroup } from 'services/Invoice/invoice-group-api';
...
export default function ViewInvoiceDialog(props: ViewInvoiceDialogProps): JSX.Element {
    ...
    const downloadPurchaseOrderFunction = (inv: Invoice, format: string) => {
        ...
        const request = type === 'INVOICE'
            ? downloadInvoice(inv.invoiceNo, format, options.original, options.copy)
            : downloadInvoiceGroup(inv.invoiceNo, format, options.original, options.copy);

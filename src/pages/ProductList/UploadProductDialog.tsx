...
import { downloadTemplate, uploadProduct } from "services/Product/product-api";
...
export default function UploadProductDialog(props: UploadProductDialogProps): JSX.Element {
    ...
    const handleConfirmUpload = async () => {
        ...
        toast.promise(uploadProduct(formData),
            {
        ...
        <Dialog open={open} maxWidth="xs" fullWidth aria-labelledby="form-dialog-title" >
            <DialogTitle id="form-dialog-title">
                <Box display="flex" justifyContent="space-between" alignItems="center">
                    <Typography variant="h6">
                        {t('productManagement.productList.uploadData')}
                    </Typography>
                    <Typography
                        variant="subtitle2"
                        onClick={() => {
                            handleDownloadTemplate('TEMPL-00002');
                        }}
            ...
            <DialogActions>
                ...
                <Button
                    ...
                    onClick={() => {
                        setTitle(t('productManagement.productList.confirmUploadTitle'));
                        setMsg(t('productManagement.productList.confirmUploadMsg'));
                        setAction('SUBMIT');

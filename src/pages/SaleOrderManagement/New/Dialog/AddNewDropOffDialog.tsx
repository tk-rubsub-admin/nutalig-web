...
import { AddCustomerDropOff, CustomerDropOff } from "services/Customer/customer-type";
...
import { Dialog, DialogTitle, DialogContent, Grid, TextField, DialogActions, Button, Autocomplete, FormControl, FormControlLabel, Radio, RadioGroup, CircularProgress } from "@mui/material";
...
import { addDropOffV2 } from "services/Customer/customer-api";

export interface AddNewDropOffDialogProps {
    open: boolean;
    customerId: string | undefined;
    onClose: (val: CustomerDropOff) => void;
}

export default function AddNewDropOffDialog(props: AddNewDropOffDialogProps): JSX.Element {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, actions) => {
            ...
            console.log(req);
            toast.promise(addDropOffV2(customerId, req), {
    ...
    return (
        <Dialog open={open} fullWidth aria-labelledby="form-dialog-title" >
            <DialogTitle id="form-dialog-title">{t('customerManagement.addNewCustomerDropOffButton')}</DialogTitle>
            <DialogContent>
                <br />
            ...
            <ConfirmDialog
                ...
                title={t('customerManagement.addNewCustomerDropOffButton')}
                message={t('customerManagement.confirmMsgNewCustomerDropOff')}

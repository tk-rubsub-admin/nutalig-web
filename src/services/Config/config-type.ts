...
export const GROUP_CODE = Object.freeze({
  ...
  CUSTOMER_BILLING_CONDITION: 'CUSTOMER_BILLING_CONDITION',
  CUSTOMER_CREDIT_TERM: 'CUSTOMER_CREDIT_TERM',
  CUSTOMER_PAYMENT_TERM: 'CUSTOMER_PAYMENT_TERM',
  CUSTOMER_PAYMENT_CYCLE: 'CUSTOMER_PAYMENT_CYCLE',
  ...
  SALES_ORDER_EXPIRE_DAY: 'SALES_ORDER_EXPIRE_DAY',
  SHIPPING_FEE_METHOD: 'SHIPPING_FEE_METHOD',
  SHIPPING_METHOD: 'SHIPPING_METHOD',
  STAFF_DEPARTMENT: 'STAFF_DEPARTMENT',
  STAFF_TYPE: 'STAFF_TYPE',
  STAFF_TYPE_2: 'STAFF_TYPE_2',
  INVOICE_EXPIRE_DAY: 'INVOICE_EXPIRE_DAY',
